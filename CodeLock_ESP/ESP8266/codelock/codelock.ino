 /*
 *  Application note: Simple Keylock / Keypad for AZ-Touch and ESP8266  
 *  Version 1.1
...
void setup() {
  ...
  digitalWrite(TFT_LED, LOW);    // LOW to turn backlight off - will hide the display during drawing
  draw_BoxNButtons(); 
  digitalWrite(TFT_LED, HIGH);    // HIGH to turn backlight on; 
}
