...
IVALIABLE v_Tmin = { 180,80,16,320,140,"Tmin",Tmin};
IVALIABLE v_Tmax = { 200,80,16,320,140,"Tmin",Tmax};
IVALIABLE v_Intv = { 220,80,16,320,140,"interval",interval};

IVALIABLE *ivariable_array[3] = { &v_Tmin,&v_Tmax,&v_Intv};

void draw_ivariable(IVARIABLE *ival, uint16_t color) {
  tft.setCursor(ival->xn,ival->yn);
  tft.setTextColor(color);
  tft.setTextSize(2);
  tft.print(ival->name);
  tft.setCursor(ival->xn,ival->yv);
  tft.print(ival->val);
}
