// JM modified Keyboard firmware for M5Stack Faces
// 
// based on FACES-Firmware/KeyBoard.ino
...
void loop()
{
  ...
  else if (kk < 36)
  {
    ...
    else
    {
      if (SYM > 0)
      {
//        if (SYM == 1)SYM = 0; // commented out to keep SYM status
        KEY = KeyMap[kk][2];
      }
      else
      {
